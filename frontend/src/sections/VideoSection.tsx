      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        <div className="group relative overflow-hidden rounded-[40px] border border-[#c98b2b]/20 shadow-2xl shadow-black/30">
          <video
            ...
            loop
            playsInline
            className="h-[80vh] min-h-[560px] w-full object-cover transition duration-700 group-hover:scale-[1.02]"
          />

          {/* Overlays */}
          <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/15 to-black/40" />

          <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_transparent_45%,_rgba(0,0,0,0.45)_100%)]" />
